package pl.tajchert.wearly.timelytextview.model;


import java.security.InvalidParameterException;

import pl.tajchert.wearly.timelytextview.model.number.*;
...
public class NumberUtils {
    ...
    public static float[][] getControlPointsFor(int start) {
        switch (start) {
            ...
            default:
                throw new InvalidParameterException("Unsupported number requested: " + start);
        }
    }
}
